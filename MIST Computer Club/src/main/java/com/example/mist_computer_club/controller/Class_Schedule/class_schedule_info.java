    ...
    void rightarrow(MouseEvent event) throws IOException {
        if(num==1){
          ...
          third_circle.setFill(Color.web("#063663"));
            ...
            num=2;
            anchor.getChildren().add(FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/admin_panes/Class_Schedule/edit_page2.fxml"))));
            return;
        }
        if(num==2){
         ...
         rightarrow.setFill(Color.web("#898989"));
            ...
            num=3;
            anchor.getChildren().add(FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/admin_panes/Class_Schedule/edit_page3.fxml"))));
            return;
        }
        ...
        if(num==2){
          ...
          second_circle.setFill(Color.web("#063663"));
           ...
           left_arrow.setFill(Color.web("#898989"));
            ...
            num=1;
            anchor.getChildren().add(FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/admin_panes/Class_Schedule/edit_page1.fxml"))));
            return;
        }
